...
export default function Home() {
  return (
    <div className="flex w-full flex-wrap items-start justify-center">
      {/* Hero Banner */}
      <div className="relative flex flex-wrap w-full justify-center items-center px-10 py-40 text-white bg-[url(/images/herobanner.jpg)] bg-cover bg-center">
        <div className="absolute inset-0 bg-linear-to-r from-[#001B3B] to-slate-900/10 z-0"></div>
        <div className="flex flex-wrap container max-w-[1200px] z-100">
          <div className="flex flex-wrap max-w-[600px] gap-8">
            ...
            <Link href="/" className="px-5 py-3 transition delay-150 duration-200 ease-in-out hover:-translate-y-2 bg-blue-500 hover:bg-white hover:text-slate-900">Get Started</Link>
          </div>
        </div>
      </div>
      {/* Services */}
      ...
      <div className="grid w-full grid-cols-1 lg:grid-cols-2 items-center">
       <div className="flex flex-wrap justify-center w-full bg-slate-200 py-15">
        <div className="flex flex-wrap">
          <img src="/images/our-feature-img.png" alt="Our features image" className="w-full h-auto transition duration-200 ease-in-out hover:-translate-y-2"/>
        </div>
        <div className="flex flex-col flex-wrap justify-center content-center px-10 max-w-[400px] gap-4">
          ...
          <Link href="/" className="text-slate-900 border border-slate-900 w-fit px-8 py-3 text-sm font-semibold transition duration-200 ease-in-out hover:-translate-y-2 hover:border-blue-500 hover:bg-blue-500 hover:text-white">Get Started Today!</Link>
        </div>
       </div>
        <div className="w-full bg-slate-900 px-10 text-white h-full items-center flex">
          <div className="flex flex-wrap flex-col justify-center gap-2 py-15">
            <div className="flex items-center gap-6 w-full hover:bg-blue-500 p-4">
              <div className="flex items-center border p-5 bg-white text-slate-900 "><MdOutlineTimer className="text-3xl"/></div>
              <div className="flex flex-wrap max-w-[500px] gap-1.5">
                <h5 className="font-bold text-xl">99% Network Uptime</h5>
                <p className="text-md">At hosting maximum performance, we&apos;re dedicated to providing top tier soulutions tailored.</p>
              </div>
            </div>
            <div className="flex items-center gap-6 w-full hover:bg-blue-500 p-4">
              <div className="flex items-center border p-5 bg-white text-slate-900 "><MdOutlineTimer className="text-3xl"/></div>
